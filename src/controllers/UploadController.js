...
const { uploadFileToBunny, deleteFileFromBunny } = require('../utils/bunnyUploader');
...
exports.uploadImages = async (req, res) => {
  try {
    ...
    if (metaArray.length !== files.length) return res.status(400).json({ message: 'Mismatch between images and metadata.' });
